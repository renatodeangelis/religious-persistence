...
# estimates and persists every matrix, and 03–05 are independent consumers that
# read the two .rds artifacts. 10–15 are robustness re-cuts of the main analysis
